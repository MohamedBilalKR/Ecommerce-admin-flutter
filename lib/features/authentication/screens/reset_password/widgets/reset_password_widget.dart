  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Row(
          children: [
            IconButton(onPressed: () => Get.offAllNamed(Routes.login), icon: const Icon(CupertinoIcons.clear)),
          ],
        ),
        ...
        SizedBox(
          ...
          child: ElevatedButton(onPressed: () => Get.offAllNamed(Routes.login), child: const Text(TTexts.done)),
        ),
        const SizedBox(height: TSizes.spaceBtwItems),
        SizedBox(
          width: double.infinity,
          child: OutlinedButton(onPressed: () {}, child: const Text(TTexts.resendEmail)),
        ),
      ],
    );
  }
