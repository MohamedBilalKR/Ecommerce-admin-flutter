import 'package:e_commerce_admin/common/widgets/chips/rounded_choice_chips.dart';
...
import 'package:e_commerce_admin/features/shop/controllers/brand/edit_brand_controller.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(onPressed: () => controller.updateBrand(brand), child: const Text('Update Brand')),
            ),
            const SizedBox(height: TSizes.spaceBtwInputFields * 2)
          ],
        ),
